%Function calculates reduced equivalen airspeed (Vre) [m/s] and equivalent
%airspeed (Ve) [m/s] at the measured points. Inputs are hp [ft] at measured points,
%Tm(=TAT) [celsius] at measured points, Vc(=VIAS) [kts] at measured points
